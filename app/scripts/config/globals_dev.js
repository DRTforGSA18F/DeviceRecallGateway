...
window.gblAntibioticsCount = 'https://api.fda.gov/drug/enforcement.json?search=product_description:Antibiotic&count=classification.exact';
...
window.gblResults = 'https://api.fda.gov/device/enforcement.json?';
